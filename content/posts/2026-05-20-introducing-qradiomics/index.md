...
The LUNGx external validation result (AUC 0.756) matches the published number exactly using only interpretable hand-crafted features, with no neural-network encoder required.
